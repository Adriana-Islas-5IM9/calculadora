...
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		super();
		setSize(700, 500);
		setTitle("Calculadora Simple - Adriana Citlali Islas Estrada_5IM9");
		...
		nuevoBotonOperacion("CE");
                ...
                nuevoBotonOperacion("arc sin");
                nuevoBotonOperacion("arc tan");
                nuevoBotonOperacion("^1/3");
                nuevoBotonOperacion("=");
	...
	private void calcularResultado() {
		if (operacion.equals("+")) {
			...
			resultado = Math.acos(Double.parseDouble(pantalla.getText()));
		} else if (operacion.equals("arc sin")) {
			resultado = Math.asin(Double.parseDouble(pantalla.getText()));
                } else if (operacion.equals("cos")) {
			resultado = Math.cos(Double.parseDouble(pantalla.getText()));
		} else if (operacion.equals("arc tan")) {
			resultado = Math.atan(Double.parseDouble(pantalla.getText()));
		} else if (operacion.equals("^1/3")) {
			resultado = Math.cbrt(Double.parseDouble(pantalla.getText()));
		}
